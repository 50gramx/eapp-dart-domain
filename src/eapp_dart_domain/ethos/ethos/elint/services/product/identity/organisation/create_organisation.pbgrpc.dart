...
@$pb.GrpcServiceName('elint.services.product.identity.organisation.CreateOrganisationService')
...
abstract class CreateOrganisationServiceBase extends $grpc.Service {
  $core.String get $name => 'elint.services.product.identity.organisation.CreateOrganisationService';
