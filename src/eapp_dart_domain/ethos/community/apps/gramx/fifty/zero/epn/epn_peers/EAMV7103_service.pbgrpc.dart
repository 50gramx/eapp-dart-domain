...
@$pb.GrpcServiceName('community.apps.gramx.fifty.zero.epn.epn_peers.EAMV7103DiscoverService')
class EAMV7103DiscoverServiceClient extends $grpc.Client {
  static final _$eAMC7102 = $grpc.ClientMethod<$0.EAMV7100, $0.EAMV7103>(
      ...
      ($core.List<$core.int> value) => $0.EAMV7103.fromBuffer(value));

  EAMV7103DiscoverServiceClient($grpc.ClientChannel channel,
      {$grpc.CallOptions? options,
      $core.Iterable<$grpc.ClientInterceptor>? interceptors})
      : super(channel, options: options,
        interceptors: interceptors);

  $grpc.ResponseFuture<$0.EAMV7103> eAMC7102($async.Stream<$0.EAMV7100> request, {$grpc.CallOptions? options}) {
...
abstract class EAMV7103DiscoverServiceBase extends $grpc.Service {
  $core.String get $name => 'community.apps.gramx.fifty.zero.epn.epn_peers.EAMV7103DiscoverService';
  ...
  $async.Future<$0.EAMV7103> eAMC7102($grpc.ServiceCall call, $async.Stream<$0.EAMV7100> request);
}
