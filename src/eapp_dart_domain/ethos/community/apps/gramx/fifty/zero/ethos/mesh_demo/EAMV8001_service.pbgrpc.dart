...
class EAMV8001DiscoverServiceClient extends $grpc.Client {
  static final _$eAMC8001 = $grpc.ClientMethod<$0.EAMV8002, $0.EAMV8001>(
      ...
      ($core.List<$core.int> value) => $0.EAMV8001.fromBuffer(value));
  ...
  $grpc.ResponseFuture<$0.EAMV8001> eAMC8001($0.EAMV8002 request, {$grpc.CallOptions? options}) {
    return $createUnaryCall(_$eAMC8001, request, options: options);
  }

  $grpc.ResponseFuture<$0.EAMV8001> eAMC8002($async.Stream<$0.EAMV8002> request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$eAMC8002, request, options: options).single;
  }

  $grpc.ResponseStream<$0.EAMV8001> eAMC8003($0.EAMV8002 request, {$grpc.CallOptions? options}) {
    return $createStreamingCall(_$eAMC8003, $async.Stream.fromIterable([request]), options: options);
  }

  $grpc.ResponseStream<$0.EAMV8001> eAMC8004($async.Stream<$0.EAMV8002> request, {$grpc.CallOptions? options}) {
...
abstract class EAMV8001DiscoverServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.EAMV8001> eAMC8001_Pre($grpc.ServiceCall call, $async.Future<$0.EAMV8002> request) async {
    return eAMC8001(call, await request);
  }

  $async.Stream<$0.EAMV8001> eAMC8003_Pre($grpc.ServiceCall call, $async.Future<$0.EAMV8002> request) async* {
    yield* eAMC8003(call, await request);
  }

  $async.Future<$0.EAMV8001> eAMC8001($grpc.ServiceCall call, $0.EAMV8002 request);
  $async.Future<$0.EAMV8001> eAMC8002($grpc.ServiceCall call, $async.Stream<$0.EAMV8002> request);
  $async.Stream<$0.EAMV8001> eAMC8003($grpc.ServiceCall call, $0.EAMV8002 request);
  $async.Stream<$0.EAMV8001> eAMC8004($grpc.ServiceCall call, $async.Stream<$0.EAMV8002> request);
}
