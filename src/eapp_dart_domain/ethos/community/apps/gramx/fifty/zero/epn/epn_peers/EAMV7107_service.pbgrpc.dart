...
//
// Generated from community/apps/gramx/fifty/zero/epn/epn_peers/EAMV7107_service.proto.
...
@$pb.GrpcServiceName(
    'community.apps.gramx.fifty.zero.epn.epn_peers.EAMV7107DiscoverService')
class EAMV7107DiscoverServiceClient extends $grpc.Client {
  ...
  EAMV7107DiscoverServiceClient(super.channel,
      {super.options, super.interceptors});

  $grpc.ResponseFuture<$0.EAMV7107> eAMC7104(
    $async.Stream<$0.EAMV7106> request, {
...
abstract class EAMV7107DiscoverServiceBase extends $grpc.Service {
  ...
  $async.Future<$0.EAMV7107> eAMC7104(
      $grpc.ServiceCall call, $async.Stream<$0.EAMV7106> request);
}
